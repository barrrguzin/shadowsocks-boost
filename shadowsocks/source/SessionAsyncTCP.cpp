...
SessionAsyncTCP::SessionAsyncTCP(boost::asio::ip::tcp::socket socket, std::shared_ptr<CryptoProvider> cryptoProvider, std::shared_ptr<boost::asio::io_context> ioContext, std::shared_ptr<spdlog::logger> logger)
